...
This is a workout tracking app. Common feature domains:
- **Auth**: User accounts, login, OAuth
- **Workout**: Exercise tracking, sets/reps, workout builder
- **Analytics**: Progress charts, statistics, trends
- **Social**: Sharing, leaderboards, community
- **Library**: Exercise database, workout templates

When creating SPECs, consider these domains to avoid feature overlap.

### SPEC Naming Convention

SPECs should follow pattern: `SPEC-DOMAIN-NNN`

Examples:
- `SPEC-AUTH-001`: Authentication features
- `SPEC-WORKOUT-001`: Workout tracking features
- `SPEC-ANALYTICS-001`: Analytics/dashboard features
- `SPEC-SOCIAL-001`: Social features
- `SPEC-LIB-001`: Exercise library features

### Quality Reminders

All implementations must meet TRUST 5:
- ✅ Tested: 85%+ coverage
